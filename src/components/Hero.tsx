          ...
          <div className="text-center md:text-left max-w-xl">
            ...
            <div className="flex justify-center md:justify-start gap-3 mt-4">
              <a href={USER_DATA.contact.socialLinks.github} target="_blank" rel="noopener noreferrer"
                 className="bg-gray-200 hover:bg-portfolio-accent hover:text-white text-gray-600 p-3 rounded-full transition-colors" aria-label="GitHub">
              ...
              <a href={USER_DATA.contact.socialLinks.linkedin} target="_blank" rel="noopener noreferrer"
                 className="bg-gray-200 hover:bg-portfolio-accent hover:text-white text-gray-600 p-3 rounded-full transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
