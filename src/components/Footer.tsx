    ...
    <footer className="bg-portfolio-blue text-white py-12">
      <div className="section-container">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          {/* Identity + CTA */}
          <div>
            <h2 className="font-heading text-2xl font-bold mb-1">{USER_DATA.personal.name}</h2>
            <p className="text-blue-200 mb-2">{USER_DATA.personal.role}</p>
        ...
        <p className="text-center text-blue-300 text-sm">
          &copy; {currentYear} {USER_DATA.personal.name}. All rights reserved.
        </p>
      </div>
    </footer>
  );
